...
void thrust_Jewel_New(Int_t startfile = 0,
		   Int_t endfile = 10,
		   Int_t jobNumber = 10222015,
		   int radius = 3,
  ...
  TFile * bad_File = new TFile(Form("jewel_bad_file_%d.root", jobNumber),"RECREATE");
  ...
  */
  ...
  string input_file = "Text_Files/jewel_file_test1k.txt";
